...
| ID | タイトル | 種別 | 状態 | 依存 | チケット |
|----|---------|------|------|------|---------|
| P4-1 | IPiperTTS インターフェース拡張 | impl | done | P1-3 | [P4-1.md](./P4-1.md) |
| P4-2 | PiperTTS.Inference.cs 実装 | impl | done | P4-1, P3-2 | [P4-2.md](./P4-2.md) |
| T4-1 | 統合テスト: タイミング付き合成 | test | done | P4-2, P2-4 | [T4-1.md](./T4-1.md) |
| T4-2 | 統合テスト: タイミング精度 | test | done | P4-2 | [T4-2.md](./T4-2.md) |
| T4-3 | 統合テスト: キャッシュ整合 | test | done | P4-2, P3-3 | [T4-3.md](./T4-3.md) |
| T4-4 | 統合テスト: durations 非対応 | test | done | P4-2 | [T4-4.md](./T4-4.md) |
| T4-5 | リグレッションテスト | test | done | P4-2 | [T4-5.md](./T4-5.md) |
