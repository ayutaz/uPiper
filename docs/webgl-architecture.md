...
| # | タスク | 依存 | 工数 | 状態 |
|---|--------|------|------|------|
| 2-1 | DotNetG2PPhonemizerのWebGL初期化パス | 1-1, 1-5, 1-6 | 中 | 未実装 |
| 2-2 | CustomDictionaryのWebGL非同期ロード | 1-5 | 小 | 未実装 |
| 2-3 | PiperTTSのWebGLガード解除・統合 | 2-1, 2-2 | 中 | 未実装 |
| 2-4 | GPUPixel推論動作確認 | 1-2 | 小 | 未実装 |
| 2-5 | ユーザーインタラクションゲートUI | 2-3, 2-4 | 小 | 未実装 |
| 2-6 | WebGLビルド統合テスト | 全Phase 1-2 | 中 | 未実装 |
