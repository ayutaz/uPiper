...
- 50文字以上のラテンテキストで en vs 他 > 98%、es/fr/pt 間 > 88% の検出精度
...
| 懸念 | 深刻度 | 対策 |
|------|--------|------|
| **ロマンス言語間の混同** | 高 | es/fr/pt は言語的類似性が高い。上位 trigram の重複が大きい（" de", "que", "ent" が3言語共通）。300 trigram プロファイルと信頼度閾値 0.65 + マージン 0.05 で緩和。50文字以上で > 88% を目標 |
